...
public class Grade {
    ...
    public Grade(Assessment assessment, Student student, LocalDateTime gradeTime, 
                 int assignmentGrade, int penalty, int finalGrade, String logText) {
        this.assessment = assessment;
        this.student = student;
        this.gradeTime = gradeTime;
        this.assignmentGrade = new BigDecimal(assignmentGrade);
        this.penalty = new BigDecimal(penalty);
        this.finalGrade = new BigDecimal(finalGrade);
        this.logText = logText;
    }
